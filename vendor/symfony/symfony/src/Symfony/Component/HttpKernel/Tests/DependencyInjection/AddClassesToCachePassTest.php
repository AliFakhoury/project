...
class AddClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\LoginSecurityController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\LoginSecurityController'))[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\LoginSecurityController',
            $expand(array('**Bundle\\Controller\\'), array('\\FooBundle\\Controller\\LoginSecurityController'))[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\LoginSecurityController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\Bar\\LoginSecurityController'))[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\LoginSecurityController',
            $expand(array('**Bundle\\Controller\\'), array('\\Bundle\\Controller\\Bar\\LoginSecurityController'))[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\LoginSecurityController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\Bundle\\Controller\\Bar\\LoginSecurityController'))[0]
        );
